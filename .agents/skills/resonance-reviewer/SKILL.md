...
| :--- | :--- | :--- |
| **PR Audit** | Pull Request | An [Atomic Review Report](references/atomic_review_report.md) listing blocking/nitpick issues. |
...
4.  **Report**: Produce the [Atomic Review Report](references/atomic_review_report.md).
5.  **Operational Self-Improvement**: Log any new architectural smells or "clever" but unreadable patterns to `learnings.jsonl`.
6.  **Decide**: Approve or Request Changes. Final status (DONE, BLOCKED, etc.).
