...
<div align="center">
    <a href="https://github.com/manusco/resonance/releases/latest"><img src="https://img.shields.io/badge/Resonance-v2.5.33-7025eb?style=for-the-badge&logo=github" alt="Resonance v2.5.33" /></a>
...
**macOS / Linux**
```bash
gh repo clone manusco/resonance ~/resonance-source -- --branch v2.5.33
python3 ~/resonance-source/resonance_update.py --source ~/resonance-source --target . --version 2.5.33
python3 ~/resonance-source/resonance_update.py --source ~/resonance-source --target . --version 2.5.33 --revision <preview-revision> --plan-digest <preview-plan-digest> --apply
```

**Windows (PowerShell)**
```powershell
gh repo clone manusco/resonance "$env:TEMP\resonance-source" -- --branch v2.5.33
py "$env:TEMP\resonance-source\resonance_update.py" --source "$env:TEMP\resonance-source" --target . --version 2.5.33
py "$env:TEMP\resonance-source\resonance_update.py" --source "$env:TEMP\resonance-source" --target . --version 2.5.33 --revision <preview-revision> --plan-digest <preview-plan-digest> --apply
```
