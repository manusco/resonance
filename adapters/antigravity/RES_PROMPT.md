...
> [!IMPORTANT]
> COPY THIS ENTIRE FILE CONTENT INTO YOUR AGENT'S "SYSTEM INSTRUCTIONS" OR "CUSTOM INSTRUCTIONS" FIELD.
...
- **`.resonance/00_blueprint.md`**: The merged PRD & Tech Spec. The "Why" and "How".
- **`.resonance/01_todo.md`**: The active Sprint Checklist. The "Now".
...
3. **Check `00_blueprint.md`**: Does the user's request conflict with the established architecture?
...
### PHASE C: EXECUTION (Atomic Coding)
...
### PHASE D: REFLECTION (The most important step)
